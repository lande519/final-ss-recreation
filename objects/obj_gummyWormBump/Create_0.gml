var x_component, y_component, offset, x_offset, y_offset;
...
with (instance_copy(false))
{
    ...
    DestroyedBy = -4;
    realBump = other.id;
    offset = round(linkedWorm.sprite_width);
    x_offset = offset * -linkedWorm.x_direction * sign(linkedWorm.image_xscale);
    y_offset = offset * -linkedWorm.y_direction * sign(linkedWorm.image_xscale);
    x += x_offset;
    y -= y_offset;
    bumpOffset = ceil(distance_to_point(linkedWorm.x, linkedWorm.y));
    clone = true;
