...
showRank = function(argument0 = global.rank)
{
    var _text;
    ...
    _text = [spr_rankD_text, spr_rankC_text, spr_rankB_text, spr_rankA_text, spr_rankS_text, -4];
    rankdex = rank_checker(argument0);
