var old, wave_x, msg, textheight, total_lines, my_height, tgty, active, drawing;

old = draw_get_font();
wave_x = wave(-5, 5, 5, 20);
draw_set_font(global.npcfont);
msg = text;
textheight = string_height_scribble_ext("[wave][c_black][spr_npcfont]" + text, 800);
total_lines = round(textheight / 32);
my_height = (total_lines + 1) * 32;
