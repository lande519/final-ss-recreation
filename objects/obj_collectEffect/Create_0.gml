var cam_x, cam_y, original_distance, original_direction;
...
image_speed = 0;
image_index = 0;
original_distance = point_distance(cam_x, cam_y, xstart, ystart);
original_direction = point_direction(cam_x, cam_y, xstart, ystart);
