...
if (sprite_animation_end() && sprite_index == spr_pizzano_hudpress)
    sprite_index = spr_pizzano_hud;

switch (state)
{
    case pizzano_dancestates.normal:
        break;
    
    case pizzano_dancestates.bomb:
        if (sprite_animation_end(undefined, 4))
        {
            ...
            state = pizzano_dancestates.normal;
        }
