...
with (other)
{
    inp = input_check_pressed("up") - input_check_pressed("down");
    inpup = input_get("up").pressed || input_get("upC").pressed;
    inpdown = input_get("down").pressed || input_get("downC").pressed;
    inp = inpup - inpdown;
