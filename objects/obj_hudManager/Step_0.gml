...
with (HUDObject_TV)
{
    ...
    with (idleScreenSaver)
    {
        ...
        target_x = keyPositions[keyframeIndex][0];
        target_y = keyPositions[keyframeIndex][1];
...
with (HUDObject_comboMeter)
{
    ...
    target_combo_time = clamp(global.ComboTime, 0, 60);
    meter_fill_width = sprite_get_width(spr_tvHUD_comboMeter_fill);
