...
bgx -= 1;
bgy -= 1;
_total_options = array_length(options);
selOption = (_total_options <= 0) ? -4 : options[optionSelected];
selID = (_total_options <= 0) ? -4 : options[optionSelected].id;
...
_option = options[optionSelected];
