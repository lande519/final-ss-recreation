var target_player, _player_dir, h_move, v_move, cdir, target_direction, m_speed;
...
if (grabbedPlayer == -4)
{
    ...
    {
        _player_dir = point_direction(xstart, ystart, target_player.x, target_player.y);
...
if (grabbedPlayer != -4)
{
    ...
    h_move = grabbedPlayer.key_left + grabbedPlayer.key_right;
    v_move = grabbedPlayer.key_down;
    ...
    if (grabBuffer <= 0)
    {
        ...
        cdir = point_direction(x, y, xstart, ystart + 70);
    ...
    {
        target_direction = point_direction(x, y, xstart, ystart + 70);
        m_speed = point_distance(x, y, xstart, ystart + 70) / 20;
