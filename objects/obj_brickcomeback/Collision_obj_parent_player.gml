if !trapped
{
	if comeback == 1 && obj_player1.sprite_index != spr_lonegustavo_punch && obj_player1.sprite_index != spr_lonegustavo_hurt && obj_player1.state != States.ratmountgroundpound && obj_player1.state != States.ratmountslide && other.state != States.ratmountlaunchprep
	{
		other.brick = true;
...
else if (other.sprite_index != spr_lonegustavo_punch or other.state == States.ratmountlaunchprep) && baddieID == noone
{
	vsp = -6;
	hsp = other.xscale * 8;
	trapped = false;
