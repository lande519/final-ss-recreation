...
if (!global.panic)
{
    ...
    {
        previous_room_music = global.RoomMusic;
...
if (global.RoomIsSecret)
{
    ...
    if (!is_undefined(global.RoomMusic) && !is_undefined(global.RoomMusic.secretMusicInst))
    {
        ...
        music_timeline_percent = fmod_studio_event_instance_get_timeline_position(global.RoomMusic.musicInst) / fmod_getEventLength(global.RoomMusic.eventName);
        secret_pos = music_timeline_percent * fmod_getEventLength(global.RoomMusic.secretEventName);
