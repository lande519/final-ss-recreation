var can_reach_player;

if (!(obj_parent_player.state == States.doughmount || obj_parent_player.state == States.doughmountspin || obj_parent_player.state == States.doughmountballoon))
{
    image_alpha = 0.35;
    exit;
}
...
can_reach_player = !place_meeting(x, y, obj_destructibles) && !place_meeting(x, y, obj_metalblock) && !place_meeting(x, y, obj_gnomeTNTBlock);
