var i, b, override, color_blend_1, color_blend_2, light_color, dark_color, pal_info;
    ...
    with (b)
    {
        ...
        if (visible)
        {
            ...
            if (color_choose != AfterImageType.plain)
            {
                ...
                light_color = obj_afterimagecontroller.color_arr[color_choose].light;
                dark_color = obj_afterimagecontroller.color_arr[color_choose].dark;
                ...
                if (color_choose == AfterImageType.wallkick && instance_exists(identity) && object_is_ancestor(identity.object_index, obj_parent_player))
                {
                    with (identity)
                    {
                        pal_info = global.CharacterPalette[global.playerCharacter].palettes[global.PlayerPaletteIndex].palColors;
