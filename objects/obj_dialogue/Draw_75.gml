var old, wave_x, msg, textheight, total_lines, my_height, tgty, active;

old = draw_get_font();
wave_x = wave(-5, 5, 5, 20);
draw_set_font(global.npcfont);
msg = text;
textheight = string_height_scribble_ext("[spr_npcfont]" + text, 800);
total_lines = floor(textheight / 32);
