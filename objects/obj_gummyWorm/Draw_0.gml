var segment_width, num_segments, i, segmentIndex, segment_sprite, segment_frame, segment_position;

segment_width = 32;
num_segments = abs(sprite_width) / segment_width;
...
for (i = 0; i < num_segments; i++)
{
    ...
    segment_sprite = segments[segmentIndex];
    segment_frame = segmentIndices[segmentIndex];
    segment_position = (i * segment_width) - offset;
