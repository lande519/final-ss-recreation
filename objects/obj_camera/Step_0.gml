...
if (room == timesuproom || room == rank_room || room == rm_credits || room == rm_titlecard || room == hub_hallway || room == hub_w2 || room == hub_w1 || room == mineshaft_elevator || is_hub() || is_tutorial())
    DrawHUD = false;
