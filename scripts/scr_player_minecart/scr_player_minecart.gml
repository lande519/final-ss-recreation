...
{
    var check1, check2, _cutscene, _xscale, slope_acceleration, _cannot_groundpound, grounded_land_sprite, grounded_sprite, i;
    
    static afterimage_timer = 2;
    static spark_timer = 1;
    
    mask_index = spr_mask_minecart;
    check1 = place_meeting_collision(x, y) || place_meeting(x, y, obj_minecartSlowdown_crouch);
    mask_index = spr_mask_minecartcrouch;
    check2 = !place_meeting_collision(x, y) && !place_meeting(x, y, obj_minecartSlowdown_crouch);
    _cutscene = [spr_player_PZ_minecart_turn, spr_player_PZ_minecart_turnidle, spr_player_PZ_minecart_bounce];
    ...
    _cannot_groundpound = [spr_player_PZ_minecart_spinOut, spr_player_PZ_minecart_groundpound, spr_player_PZ_minecart_groundpoundstart];
    ...
    if (sprite_index != spr_player_PZ_minecart_spinOut)
    {
        grounded_land_sprite = spr_player_PZ_minecart_land;
        grounded_sprite = spr_player_PZ_minecart;
...
function state_player_minecart_launched()
{
    ...
    _cannot_groundpound = [spr_player_PZ_minecart_jump, spr_player_PZ_minecart_bounce, spr_player_PZ_minecart_spinOut, spr_player_PZ_minecart_groundpound, spr_player_PZ_minecart_groundpoundstart];
