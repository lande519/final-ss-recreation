...
function player_slopeMomentum(argument0, argument1 = 0)
{
    var inst, _xscale, slope_acceleration;
    
    inst = instance_place(x, y + 1, obj_slopePlatform);
    ...
    {
        _xscale = sign(inst.image_xscale);
        slope_acceleration = abs(inst.image_yscale) / abs(inst.image_xscale);
