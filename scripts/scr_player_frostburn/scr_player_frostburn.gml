function state_player_frostburnnormal() //state_player_frostburnnormal
{
	if grounded
	{
		jumpedOnce = false
    ...
    if sprite_index == spr_player_PZ_frostburn_doubleJump_intro && sprite_animation_end()
...
function state_player_frostburnslide() //state_player_frostburnslide
{
	if grounded
	{
		jumpedOnce = false
...
function state_player_frostburnjump() //state_player_frostburnjump
{
    ...
    if (vsp >= terminalVelocity || sprite_index == spr_player_PZ_frostburn_spin || ((doubleJumped || sprite_index == spr_player_PZ_frostburn_wallJump || sprite_index == spr_player_PZ_frostburn_wallJump_intro) && vsp >= 1))
    {
        jumpStop = true
...
function state_player_frostburnstick() //state_player_frostburnstick
{
    doubleJumped = false
    jumpStop = true
    momentum = false
