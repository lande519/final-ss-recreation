...
{
    var p, _dir, target_player, hitbox_exists, playerposition, player_present;
    ...
    switch (object_index)
    {
        ...
        case obj_sluggy:
            ...
            if (sprite_index == spr_sluggy_underground)
            {
                ...
                if ((enemyAttackTimer <= 0 || player_present || !place_meeting(x + hsp, y + 1, obj_dirtpatch)) && obj_parent_player.state != States.freefallland)
                {
