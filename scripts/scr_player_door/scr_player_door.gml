...
{
    var door_objects, i, door_obj, _inst;
    ...
    door_objects = [obj_door, obj_keydoor, obj_keydoorclock];
    
    for (i = 0; i < array_length(door_objects); i++)
    {
        door_obj = door_objects[i];
            ...
            with (instance_place(x, y, door_obj))
            {
                switch (sprite_index)
                {
                    ...
                    case spr_door_mindpalace2:
                        _inst = instance_place(x, y, obj_parent_doortrigger);
