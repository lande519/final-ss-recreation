...
{
    var sprite_transitions, i, move_sprites, jump_sprites, landing_transitions, air_sprites, rep;
    ...
    sprite_transitions = [[spr_cottonDashOut, spr_cottonFall], [spr_cottonJump, spr_cottonFall], [spr_cottonDoubleJump, spr_cottonDoubleJumpFall]];
    
    if (!place_meeting(x, y, obj_cottonsolid))
    {
        for (i = 0; i < array_length(sprite_transitions); i++)
        {
    ...
    jump_sprites = [spr_cottonJump, spr_cottonDoubleJump, spr_cottonFall, spr_cottonDoubleJumpFall, spr_player_PZ_werecotton_spin];
    ...
    landing_transitions = [[spr_cottonLand, spr_cottonIdle], [spr_cottonLandWalk, spr_cottonWalk]];
    
    for (i = 0; i < array_length(landing_transitions); i++)
    {
