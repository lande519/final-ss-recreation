...
function is_hub(argument0 = room)
{
    ...
    hub_rooms = [hub_soundTest, hub_hallway, hub_w1, hub_w2, hub_w3, hub_w4, hub_molasses, hub_mindpalace, hub_mindvault, rm_credits];
...
function is_boss(argument0 = room)
{
    ...
    boss_rooms = [boss_pizzano, boss_painter, boss_peppino, boss_gumbob];
