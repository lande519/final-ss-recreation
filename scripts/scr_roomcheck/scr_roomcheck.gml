...
function is_hub(argument0 = room)
{
    ...
    hub_rooms = [hub_soundTest, hub_secret1, hub_coneballentrance, hub_outer, hub_outside, ctop_1, hub_hallway, hub_w1, hub_w2, hub_w3, hub_w4, hub_molasses, hub_mindpalace, hub_mindvault, rm_credits];
