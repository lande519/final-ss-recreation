...
{
    var _ledge, aerial_sprite_transitions, i;
    ...
    if (!stompAnim)
    {
        ...
        if (!jumpAnim)
        {
            aerial_sprite_transitions = [[spr_suplexdashCancel, spr_fall], [spr_piledriverJump, spr_fall], [spr_jump, spr_fall]];
            
            for (i = 0; i < array_length(aerial_sprite_transitions); i++)
            {
